...
typedef enum { WF_TRIANGLE = 0, WF_SAWTOOTH, WF_PULSE, WF_NOISE } waveform_t;

/* Lookup tables for envelope durations. */
static const int atk_ms[16] = {2,   8,   16,  24,  38,   56,   68,   80,
                               100, 250, 500, 800, 1000, 3000, 5000, 8000};

static const int dec_ms[16] = {6,   24,  48,   72,   114,  168,  204,   240,
                               300, 750, 1500, 2400, 3000, 9000, 15000, 24000};

static const int rls_ms[16] = {6,   24,  48,   72,   114,  168,  204,   240,
                               300, 750, 1500, 2400, 3000, 9000, 15000, 24000};
